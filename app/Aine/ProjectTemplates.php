...
{
    public const CMS = 1;
    public const BUSINESS_DIRECTORY = 2;
    public const NOTE = 3;

    /**
     * Map template type constants to their slug identifiers.
     * Used by get() to look up templates by slug instead of auto-increment ID,
     * which is unreliable (depends on insertion order).
     */
    private const SLUGS = [
        self::CMS => 'cms',
        self::BUSINESS_DIRECTORY => 'directory',
        self::NOTE => 'note',
    ];
                ...
                'collections' => [
                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            ['order' => 12, 'type' => 'enumeration', 'label' => 'Comments Moderation', 'name' => 'comments_moderation', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": ["auto","approval","disabled"],"hideInContentList": true}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}']
                        ],
                    ],
                    [
                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            ['order' => 1, 'type' => 'enumeration', 'label' => 'Status', 'name' => 'status', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": ["pending","approved","spam","trash"],"hideInContentList": true}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                        ],
                    ],
                    [
                ...
                'collections' => [
                    [
                        ...
                        'fields' => [
                            ...
                            ['order' => 2, 'type' => 'slug', 'label' => 'Path', 'name' => 'slug', 'options' => '{"slug": {"field": "title"},"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": true,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 3, 'type' => 'url', 'label' => 'Website', 'name' => 'website', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 4, 'type' => 'longtext', 'label' => 'Description', 'name' => 'description', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 5, 'type' => 'relation', 'label' => 'Category', 'name' => 'category', 'options' => '{"slug": [],"media": [],"relation": {"type": "1","collection": "{{categories}}"},"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 6, 'type' => 'relation', 'label' => 'Tags', 'name' => 'tags', 'options' => '{"slug": [],"media": [],"relation": {"type": "2","collection": "{{tags}}"},"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 7, 'type' => 'relation', 'label' => 'Location', 'name' => 'location', 'options' => '{"slug": [],"media": [],"relation": {"type": "1","collection": "{{locations}}"},"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 8, 'type' => 'media', 'label' => 'Logo', 'name' => 'logo', 'options' => '{"slug": [],"media": {"type": 1},"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 9, 'type' => 'media', 'label' => 'Gallery', 'name' => 'gallery', 'options' => '{"slug": [],"media": {"type": 2},"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 10, 'type' => 'text', 'label' => 'Phone', 'name' => 'phone', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 11, 'type' => 'email', 'label' => 'Email', 'name' => 'email', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            ['order' => 1, 'type' => 'slug', 'label' => 'Path', 'name' => 'slug', 'options' => '{"slug": {"field": "name"},"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": true,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                        ],
                    ],
                    [
                ...
                'collections' => [
                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            ['order' => 5, 'type' => 'media', 'label' => 'Featured Image', 'name' => 'featured-image', 'options' => '{"slug": [],"media": {"type": 1},"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 6, 'type' => 'relation', 'label' => 'Category', 'name' => 'category', 'options' => '{"slug": [],"media": [],"relation": {"type": "1","collection": "{{categories}}"},"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 7, 'type' => 'relation', 'label' => 'Tags', 'name' => 'tags', 'options' => '{"slug": [],"media": [],"relation": {"type": "2","collection": "{{tags}}"},"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 8, 'type' => 'boolean', 'label' => 'Slider', 'name' => 'slider', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 9, 'type' => 'boolean', 'label' => 'Featured', 'name' => 'featured', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 10, 'type' => 'boolean', 'label' => 'Recommended', 'name' => 'recommended', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": false,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                        ],
                    ],
                    [
                        'name' => 'Categories', 'slug' => 'categories', 'order' => 3,
                    ...
                    [
                        'name' => 'Tags', 'slug' => 'tags', 'order' => 4,
                        'fields' => [
                            ['order' => 1, 'type' => 'text', 'label' => 'Tag', 'name' => 'tag', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                        ],
                    ],
                    [
                        'name' => 'Globals', 'slug' => 'globals', 'order' => 5,
                        'fields' => [
                            ['order' => 1, 'type' => 'slug', 'label' => 'Label', 'name' => 'label', 'options' => '{"slug": {"field": null},"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": true,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                            ['order' => 1, 'type' => 'text', 'label' => 'Value', 'name' => 'value', 'options' => '{"slug": [],"media": [],"relation": [],"enumeration": [],"hideInContentList": false}', 'validations' => '{"unique": {"status": false,"message": null},"required": {"status": true,"message": null},"charcount": {"max": null,"min": null,"type": "Between","status": false,"message": null}}'],
                        ],
    ...
    /**
     * Get one template definition by type constant.
     * Looks up by slug (reliable) instead of auto-increment ID (unreliable).
     * Falls back to hardcoded definitions in all() if DB record is missing/empty.
     */
    public static function get(int $id): ?array
    {
        ...
        if ($slug) {
            $t = \App\Models\ProjectTemplate::where('slug', $slug)->first();
            if ($t && ! empty($t->collections)) {
                return ['name' => $t->name, 'collections' => $t->collections];
            }
        }
