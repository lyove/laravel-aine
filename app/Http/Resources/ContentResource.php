...
class ContentResource extends JsonResource
{
    ...
    /**
     * Clear per-request static state. Called by AppServiceProvider when the
     * request terminates so a long-lived process (Octane / queue worker)
     * never carries cycle-detection state between requests.
     */
