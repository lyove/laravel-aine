        ...
        $activities = Content::whereIn('project_id', $accessibleProjectIds)
            ...
            ->map(function ($content) {
                ...
                return [
                    'id' => $content->id,
                    'action' => $action,
                    'content_title' => $content->meta->where('field_name', 'title')->first()->value ?? 'Untitled',
                    'collection_name' => $content->collection->name ?? 'Unknown',
                    'project_name' => $content->collection->project->name ?? 'Unknown',
                    'project_id' => $content->project_id,
                    'collection_id' => $content->collection_id,
                    'user_name' => $content->creator->name ?? 'Unknown',
