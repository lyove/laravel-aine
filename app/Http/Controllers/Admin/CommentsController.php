    ...
    public function index(Request $request, int $projectId)
    {
        ...
        $rows = $comments->map(function (Content $comment) use ($project, $articleTitles) {
            ...
            return [
                ...
                'article_title' => $articleId !== null ? ($articleTitles[$articleId] ?? __('Deleted article')) : null,
