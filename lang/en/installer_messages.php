...
return [
    ...
    */
    'permissions' => [
        ...
        'errors_title' => 'Permission check failed',
        'errors_description' => 'One or more folders are not writable by the web/PHP process. Even if the octal permission looks correct, the actual runtime user may lack write access. Please fix the permissions before continuing.',
        'retry' => 'Retry',
    ],
