...
@section('container')
    ...
    <div data-tabs>
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="mt-6">
            ...
            {{-- Environment --}}
            <div id="envPanel" data-panel class="space-y-6">
                {{-- Section: Application settings --}}
                <div class="overflow-hidden rounded-xl ring-1 ring-slate-200 bg-white shadow-sm">
                    <div class="flex items-center gap-2 border-b border-slate-200 bg-blue-50 px-4 py-3">
                        <h3 class="text-sm font-bold uppercase tracking-wide text-blue-700">{{ trans('installer_messages.environment.wizard.tabs.environment') }}</h3>
                    </div>
                ...
                {{-- Section: Database --}}
                <div class="overflow-hidden rounded-xl ring-1 ring-slate-200 bg-white shadow-sm">
                    <div class="flex items-center gap-2 border-b border-slate-200 bg-emerald-50 px-4 py-3">
                        <h3 class="text-sm font-bold uppercase tracking-wide text-emerald-700">{{ trans('installer_messages.environment.wizard.tabs.database') }}</h3>
                    </div>
                    <div class="space-y-4 p-4 sm:p-5">
                ...
                <div class="overflow-hidden rounded-xl ring-1 ring-slate-200 bg-white shadow-sm">
                    <div class="flex items-center gap-2 border-b border-slate-200 bg-amber-50 px-4 py-3">
                        <h3 class="text-sm font-bold uppercase tracking-wide text-amber-700">{{ trans('installer_messages.environment.wizard.form.app_tabs.admin_label') }}</h3>
                    </div>
                    <div class="space-y-4 p-4 sm:p-5">
                    <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div id="otherPanel" data-panel class="hidden space-y-6">
                ...
                <div class="space-y-4">
                    <h3 class="font-semibold text-slate-700">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_title') }}</h3>
                    <div class="grid gap-4 sm:grid-cols-2">
                ...
                {{-- Redis --}}
                <div class="space-y-4">
                    <h3 class="font-semibold text-slate-700">{{ trans('installer_messages.environment.wizard.form.app_tabs.redis_label') }}</h3>
                    <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div class="space-y-4">
                    <h3 class="font-semibold text-slate-700">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_label') }}</h3>
                ...
                {{-- Pusher --}}
                <div class="space-y-4">
                    <h3 class="font-semibold text-slate-700">{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_label') }}</h3>
                    <div class="grid gap-4 sm:grid-cols-2">
