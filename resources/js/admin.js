...
window.axios.defaults.baseURL = window.ADMIN_API_BASE || "/admin-api";
...
/* ------------------------------------------------------------------ */
/* Create Vue app & register plugins                                    */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* Boot — preload user, then mount, then init locale & settings        */
/* ------------------------------------------------------------------ */
...
(async () => {
    // Preload user so role-gated sidebar items (Setting, Users) render on first paint
    await adminStore.getUser();

    // Mount
    app.mount("#admin");

    // Activate the saved admin UI language.
    adminStore.initUiLocale();
