    ...
    methods: {
        ...
        async resolveEntity() {
            ...
            if (this.mode === "category") {
                list = await api.getDirectoryCategories();
            } else if (this.mode === "tag") {
                list = await api.getDirectoryTags();
            } else {
        ...
        async fetchPage() {
            ...
            if (this.mode === "all") {
                ...
                data = await api.getCategoryListings(this.entityId, {
                    offset: this.offset,
                    limit: ARCHIVE_PAGE_SIZE,
                    sort: "published_at:desc",
                    timestamps: true,
                ...
                data = await api.getLocationListings(this.entityId, {
                    offset: this.offset,
                    limit: ARCHIVE_PAGE_SIZE,
                    sort: "published_at:desc",
                    timestamps: true,
