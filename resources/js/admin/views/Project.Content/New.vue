        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <div class="w-9/12 flex flex-col">
                <div class="px-4 py-2 font-bold text-lg flex justify-between flex-shrink-0">
                    ...
                    <div class="flex">
                        <ui-button :color="'indigo-500'" class="rounded-r-none" :disabled="isReadonly" @click="saveNew(true)">{{ __('Save') }}</ui-button>

                        <div v-if="!isReadonly" class="flex border-indigo-600 border border-l-1 border-t-0 border-b-0 border-r-0">
            ...
            this.editableFields.forEach(field => {
                ...
                if (isRequired) {
                    ...
                    if (value === null || value === undefined || value === '') {
                        ...
                        // Check if all repeatable values are empty
                ...
                Object.keys(errors).forEach(key => {
                    if (key.startsWith('data.')) {
                        ...
                        if (value !== null && value !== undefined && value !== '' && !(Array.isArray(value) && value.length === 0)) {
                            // Check if the specific value is non-empty
                            let hasValue = false;
