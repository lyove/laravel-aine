                ...
                <div class="p-4">
                    ...
                    <div class="w-full bg-white mt-2 rounded-md p-4">
                        ...
                        <div class="mt-10">
                            <label
                                for="togglePublic"
                                class="p-5 border border-gray-300 rounded-md text-sm flex items-center space-x-2"
                                :class="{ 'cursor-pointer': !isReadonly, 'opacity-50': isReadonly }"
                            ...
                            >
                                <div class="relative">
                                    <input
                                        ...
                                        @click.prevent="!isReadonly && disablePublicAccess()"
                                    />
                            ...
                            >
                                <div class="relative">
                                    <input
                                        ...
                                        class="sr-only"
                                        v-model="enable_public_access"
                                        @click.prevent="!isReadonly && enablePublicAccess()"
                                    />
                                    <div class="block bg-gray-600 w-10 h-6 rounded-full"></div>
                                    <div class="dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition"></div>
                                </div>
