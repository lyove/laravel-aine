                    ...
                    <div v-if="activeTab === 'general'" class="w-full bg-white rounded-md p-4">
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    <input type="text" v-model="form.slug" v-forminput placeholder="project-slug" pattern="[a-z0-9\-]+" @blur="checkSlug" @input="onSlugInput" />
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    <input type="text" v-model="form.copyright" v-forminput placeholder="© 2026 Your Company" />
                                </div>
                            </div>
                            <div>
                    ...
                    <div v-if="activeTab === 'logo'" class="w-full bg-white rounded-md p-4">
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            <div>
                                ...
                                <div class="mt-1 relative"><input type="text" v-model="form.logo_url" v-forminput placeholder="/storage/logo.png" /></div>
                            </div>
                            <div>
                                <label v-formlabel>{{ __('Favicon URL') }}</label>
                                <div class="mt-1 relative"><input type="text" v-model="form.favicon_url" v-forminput placeholder="/storage/favicon.ico" /></div>
                            </div>
                            <div>
                                <label v-formlabel></label>
                    ...
                    <div v-if="activeTab === 'custom'" class="w-full bg-white rounded-md p-4">
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            <div>
                                ...
                                <div class="mt-1 relative"><textarea v-model="form.custom_header" v-forminput rows="6" class="font-mono text-xs" placeholder="<style>...</style> or <script>...</script>"></textarea></div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative"><textarea v-model="form.custom_footer" v-forminput rows="6" class="font-mono text-xs" placeholder="<div>...</div> or <script>...</script>"></textarea></div>
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="mt-1 relative"><input type="email" v-model="form.contact_email" v-forminput placeholder="contact@example.com" /></div>
                                </div>
                                <div>
                                    <label v-formlabel>{{ __('Phone') }}</label>
                                    <div class="mt-1 relative"><input type="text" v-model="form.contact_phone" v-forminput placeholder="+1 234 567 890" /></div>
                                </div>
                            </div>
                            <div>
