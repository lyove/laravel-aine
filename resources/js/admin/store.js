...
/**
 * Reveal the admin shell once the boot UI language has been applied.
 */
 ...
 * the per-user topbar switcher was removed.
 */
...
export const useAdminStore = defineStore('admin', {
    ...
    actions: {
        ...
        /**
         * Apply the global default UI language.
         */
