<template>
    ...
    >
        <img :src="logoUrl" :alt="__('Logo')" :class="imgclass" />
    </router-link>
</template>
...
<script>
    export default {
        ...
        data() {
            return {
                appUrl: document.querySelector('meta[name="APP_URL"]').content,
            }
        },

        computed: {
            logoUrl() {
                const appUrl = document.querySelector('meta[name="APP_URL"]').content;
                const SizeMap = {
                    sm: '32x32',
                    md: '64x64',
                    lg: '256x256'
