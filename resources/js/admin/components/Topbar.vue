...
export default {
    ...
    computed: {
        ...
        userName() {
            return this.user.name || this.__('User');
        },
    ...
    methods: {
        ...
        actionLabel(action) {
            const labels = {
                publish: this.__("Published"),
                unpublish: this.__("Unpublished"),
                trash: this.__("Moved to trash"),
                restore: this.__("Restored"),
                delete: this.__("Deleted"),
                create: this.__("Created"),
