...
Route::middleware(['auth:web', 'backend.user'])->prefix(\App\Support\AdminPath::apiSlug())->group(function(){
    ...
    Route::prefix('collections')->middleware('project.readonly')->group(function(){
    ...
    Route::prefix('content')->middleware('project.readonly')->group(function(){
    ...
    Route::prefix('media')->middleware('project.readonly')->group(function(){
        ...
        Route::post('/upload-chunk/{project_id}', [MediaLibraryController::class, 'uploadChunk']);
        Route::post('/upload-complete/{project_id}', [MediaLibraryController::class, 'uploadComplete']);
