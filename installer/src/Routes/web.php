...
use Aine\Installer\Middleware\SetInstallerLocale;
use Illuminate\Support\Facades\Route;

Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'Aine\Installer\Controllers', 'middleware' => ['web', 'install', SetInstallerLocale::class]], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Aine\Installer\Controllers', 'middleware' => 'web'], function () {
